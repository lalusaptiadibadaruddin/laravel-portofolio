            ...
            $(document).on('click', '.detailPlants', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#images").html(
                            `<img src="{{ asset('storage/img/${response.plant.image}') }}" width="200" height="200" class="img-fluid img-thumbnail">`
                        );
                    }
                });
            });
            ...
            $(document).on('click', '.editPlants', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#imagesEdit").html(
                            `<img src="{{ asset('storage/img/${response.image}') }}" width="100" class="img-fluid img-thumbnail">`
                        );
